...
| Primary capability | Long-form 80/20 story and architecture explanation |

## Purpose

Explain what Revisium provides, what the custom backend provides, and how the
federated demo is assembled.
